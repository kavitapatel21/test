      ...
      <div class="container h-100">
        <div class="row align-items-center h-100">
          ...
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/bg_image_1.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-6 col-lg-4 py-3 wow fadeInUp">
            <div class="d-flex flex-row">
              <div class="img-fluid mr-3">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/icon_pattern.svg" alt="">
              </div>
              <div>
        ...
        <div class="row">
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place text-center">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/bg_image_2.png" alt="">
            </div>
          </div>
          <div class="col-lg-6 py-3 wow fadeInRight">
            ...
            <div class="img-place mb-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/testi_image.png" alt="">
            </div>
    ...
    <div class="page-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 py-3 wow zoomIn">
            <div class="img-place text-center">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/bg_image_3.png" alt="">
            </div>
          </div>
        </div>
      </div> <!-- .container -->
        ...
        <div class="owl-carousel wow fadeInUp" id="testimonials">
            ...
            <div class="row align-items-center">
              <div class="col-md-6 py-3">
                <div class="testi-image">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/person/person_1.jpg" alt="">
                </div>
              </div>
              <div class="col-md-6 py-3">
          ...
          <div class="item">
            <div class="row align-items-center">
              <div class="col-md-6 py-3">
                <div class="testi-image">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/person/person_2.jpg" alt="">
                </div>
              </div>
              <div class="col-md-6 py-3">
                <div class="testi-content">
        ...
        <div class="row my-5 card-blog-row">
          ...
          <div class="col-md-6 col-lg-3 py-3 wow fadeInUp">
            <div class="card-blog">
              <div class="header">
                <div class="avatar">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/person/person_3.jpg" alt="">
                </div>
                <div class="entry-footer">
                  <div class="post-author">Sam Newman</div>
                  <a href="#" class="post-date">23 Apr 2020</a>
      ...
      <div class="container-fluid">
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 justify-content-center">
          <div class="item wow zoomIn">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/airbnb.png" alt="">
          </div>
          <div class="item wow zoomIn">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/google.png" alt="">
          </div>
          <div class="item wow zoomIn">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/stripe.png" alt="">
          </div>
          <div class="item wow zoomIn">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/paypal.png" alt="">
          </div>
          <div class="item wow zoomIn">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/clients/mailchimp.png" alt="">
          </div>
        </div>
      </div> <!-- .container-fluid -->
    </div> <!-- .page-section -->
